...
function massBalances(t,y,dydt,data_dictionary)
	...
	dydt[47,1] = +r[60]+r[61]+r[62]-r[63]+r[78]+r[79]+r[95]; # d/dt[ LCA1 ].
	...
	dydt[69,1] = +r[110]-r[118]-r[122]/2+r[135]-r[137]+r[139]-r[143]+r[145]-r[153]+r[154]-r[155]+r[156]+r[170]+r[171]+r[177]; # d/dt[ FnII2 ].
	...
	dydt[74,1] = -r[116]+r[128]+r[121]+r[122]/2-r[133]+r[134]-r[142]-r[143]+r[144]+r[145]-r[158]+r[159]+r[164]-r[175]-r[178]-r[182]; # d/dt[ Pn ].
	dydt[75,1] = -r[116]-r[167]-r[168]-r[169]-r[170]-r[171]; # d/dt[ AP ].
	dydt[76,1] = +r[116]+r[167]+r[168]+r[169]+r[170]+r[171]+r[175]+r[176]+r[177]; # d/dt[ Pn_AP ].
	dydt[77,1] = +r[121]+2*r[122]+2*r[166]; # d/dt[ FDP ].
	...
	dydt[81,1] = -r[128]-r[130]+r[131]-r[136]-r[137]+r[138]+r[139]-r[149]+r[150]; # d/dt[ Pg ].
	dydt[82,1] = +r[124]-r[125]-r[126]; # d/dt[ artPA ].
	dydt[83,1] = -r[127]; # d/dt[ ictPA ].
	dydt[84,1] = -r[132]-r[174]; # d/dt[ uPa ].
	dydt[85,1] = 0; # d/dt [ Pg_TXA ]
	dydt[86,1] = -r[130]+r[131]-r[133]+r[134]-r[147]+r[148]-r[149]+r[150]-r[151]+r[152]+r[157]-r[158]+r[159]-r[160]+r[161]-r[162]+r[163]+r[164]; # d/dt [ TXA ]
	dydt[87,1] = +r[132]; # d/dt[ uPa_PAI ].
	dydt[88,1] = 0; # d/dt [ Pn_TXA ]
	dydt[89,1] = +r[117]-r[120]; # d/dt[ stPA_FnII ].
	dydt[90,1] = +r[118]-r[135]; # d/dt[ stPA_FnII2 ].
	dydt[91,1] = +r[136]-r[138]-r[140]; # d/dt[ Pg_FnII ].
	dydt[92,1] = +r[137]-r[139]-r[141]-r[172]; # d/dt[ Pg_FnII2 ].
	dydt[93,1] = -r[121]+r[140]+r[142]-r[144]; # d/dt [ Pn_FnII ]
	dydt[94,1] = -r[122]/2+r[141]+r[143]-r[145]-r[170]+r[172]; # d/dt [ Pn_FnII2 ]
	dydt[95,1] = -r[129]+r[130]-r[131]-r[147]+r[148]-r[153]+r[154];#Pgx
	dydt[96,1] = +r[149]-r[150]-r[151]+r[152]-r[164];#Pgy
	dydt[97,1] = +r[147]-r[148]+r[151]-r[152]-r[157];#Pgxy
	dydt[98,1] = +r[153]-r[154]-r[165]-r[173];#Pgx_FnII2
	dydt[99,1] = +r[129]+r[133]-r[134]-r[155]+r[156]+r[157]-r[160]+r[161]+r[166]-r[167]-r[176]-r[179]-r[183];#Pnx
	dydt[100,1] = +r[160]-r[161]+r[162]-r[163]-r[168]-r[181]-r[185];#Pnxz
	dydt[101,1] = +r[155]-r[156]+r[165]-r[166]-r[171]+r[173]-r[177];#Pnx_FnII2
	dydt[102,1] = +r[158]-r[159]-r[162]+r[163]-r[169]-r[180]-r[184];#Pnz
	dydt[103,1] = -r[174];#PCI
	dydt[104,1] = -r[175]-r[176]-r[177];#APnc
	dydt[105,1] = -r[178]-r[179]-r[180]-r[181]; #a2mg
	dydt[106,1] = -r[182]-r[183]-r[184]-r[185]; #a1at
	dydt[107,1] = +r[178]+r[179]+r[180]+r[181]; #Pn_a2mg
	dydt[108,1] = +r[182]+r[183]+r[184]+r[185]; #Pn_a1at
end
