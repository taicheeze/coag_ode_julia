function calculateRates(t,y,data_dictionary)
	...
	RxnRates=Array{Float64,1}(undef,146);
	...
	RxnRates[140,1]=Kvalues[140]*y[89]*y[91]/(y[91]+0.19e-6); 		# r[148] = k73*stPA_Pg_FnII forms plasmin
	RxnRates[141,1]=Kvalues[141]*y[90]*y[92]/(y[92]+0.19e-6); 		# r[149] = k67*stPA_Pg_FnII2 forms plasmin
