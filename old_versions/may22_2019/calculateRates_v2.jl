function calculateRates(t,y,data_dictionary)
	...
	RxnRates=Array{Float64,1}(undef,167);
	...
	RxnRates[145,1]=Kvalues[145]*y[94]; 		# r[153] = k90*Pn_FnII2
	...
	RxnRates[157,1]=Kvalues[157]*y[97]*y[84]/(2.5e-5+y[97]);	# upa activation of Pgxy, decreases Pgxy, increases Pnxy
	RxnRates[158,1]=Kvalues[158]*y[74]*y[86];			# binding of TXA to Pn, decreases TXA and Pn, increases Pny
	RxnRates[159,1]=Kvalues[159]*y[102]; 				# unbinding of Pny, decreases Pny, increases TXA and Pg
	RxnRates[160,1]=Kvalues[160]*y[99]*y[86]; #binding Pnx with TXA forming Pnxy
	RxnRates[161,1]=Kvalues[161]*y[100]; #unbinding Pnxy forming TXA and Pnx
	RxnRates[162,1]=Kvalues[162]*y[102]*y[86]; #binding Pny with TXA forming Pnxy
	RxnRates[163,1]=Kvalues[163]*y[100]; #unbinding Pnxy forming TXA and Pgy
	RxnRates[164,1]=Kvalues[164]*y[96]*y[84]/(2.5e-5+y[96]);	# upa activation of Pgy, decreases Pgy, increases Pny
	RxnRates[165,1]=Kvalues[165]*y[90]*y[98]/(y[98]+0.19e-6); 		# tpa activation of Pnx_FnII2
	RxnRates[166,1]=Kvalues[166]*y[101]; 		# Pnx_FnII2 degrading fibrin increases FDP, Pnx
	RxnRates[167,1]=Kvalues[116]*y[99]*y[75]; 		# r[116] = k77*Pnx*AP
	return RxnRates;
end
